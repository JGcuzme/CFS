...
def RFC_1():
    ...
    for i in tqdm(range(1000), desc="Training"):
        ...
        ABC1 = RandomForestClassifier(oob_score=True, random_state=13, max_samples=64)
...
def RFC_3():
    ...
    """RF: NHANES data"""
    data = pd.read_csv(r"../data/dataset/all_standard.csv")
    feature = feature_selection_rfe_svr(data, 33)
    target = data["DIQ010"]
    dataset = feature
...
def RFC_4():
    ...
    """RF: NHANES data"""
    data = pd.read_csv(r"../data/dataset/all_standard.csv")
    feature = feature_selection_mrmr(data, 33)
    target = data["DIQ010"]
    dataset = feature
...
def RFC_5():
    ...
    """RF: NHANES data"""
    data = pd.read_csv(r"../data/dataset/all_standard.csv")
    feature = feature_selection_rrelieff(data, 33)
    target = data["DIQ010"]
    dataset = feature
...
def RFC_6():
    ...
    """RF: NHANES data"""
    data = pd.read_csv(r"../data/dataset/all_standard.csv")
    feature = feature_selection_pca(data, 33)
    target = data["DIQ010"]
    dataset = feature
